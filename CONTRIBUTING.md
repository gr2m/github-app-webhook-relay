...
Thank you for considering to contribute to `github-app-webhook-relay` 💖
...
1. Fork this repository and clone it to your local machine. Using `gh` you can do this
   ...
   ```
   gh repo fork gr2m/github-app-webhook-relay
   ```

2. After cloning and changing into the `github-app-webhook-relay` directory, install dependencies and run the tests
...
Unless the change is trivial such as a type, please [open an issue first](https://github.com/gr2m/github-app-webhook-relay/issues/new) before starting a pull request for a bug fix or a new feature.
